...
START_TEST(s21_mul_test_0) {
  ...
  s21_decimal value2;
  s21_decimal result;
  s21_from_int_to_decimal(a, &value1);
  s21_from_int_to_decimal(b, &value2);
  int code = s21_mul(value1, value2, &result);
  s21_from_decimal_to_int(result, &mul);
...
START_TEST(s21_mul_test_7) {
  ...
  int code = s21_from_decimal_to_int(result, &mul);
  s21_from_decimal_to_int(result, &mul);
  ck_assert_int_eq(mul, a * b);
  ck_assert_int_eq(code, 0);
}
...
/*START_TEST(s21_mul_test_25) {
  ...
  s21_decimal value2;
  s21_decimal result;
  s21_from_float_to_decimal(a, &value1);
  s21_from_float_to_decimal(b, &value2);
  int code = s21_mul(value1, value2, &result);
  s21_from_decimal_to_float(result, &mul);
  ck_assert_int_eq(mul, a * b);
  ck_assert_int_eq(code, 0);
}
END_TEST
...
START_TEST(s21_mul_test_45) {
  s21_decimal value1;  // value1 = 79228162514264337593543950335
  ...
  s21_decimal expected;  // expected = 47536897508558602556126370201
...
START_TEST(s21_mul_test_47) {
  s21_decimal value1;  // value1 = 79228162514264337593543950334
  value1.bits[3] = 0b00000000000000000000000000000000;
  value1.bits[2] = 0b11111111111111111111111111111111;
  value1.bits[1] = 0b11111111111111111111111111111111;
  ...
  s21_decimal expected;  // expected = 47536897508558602556126370200
  expected.bits[3] = 0b00000000000000000000000000000000;
  expected.bits[2] = 0b10011001100110011001100110011001;
  expected.bits[1] = 0b10011001100110011001100110011001;
...
START_TEST(s21_mul_test_48) {
  s21_decimal value1;  // value1 = 45473458277750
  value1.bits[3] = 0b00000000000000000000000000000000;
  ...
  s21_decimal value2;  // value2 = 1118159217325
  ...
  s21_decimal expected;  // expected = 50846566516909982462018750
  expected.bits[3] = 0b00000000000000000000000000000000;
...
START_TEST(s21_mul_test_52) {
  ...
  s21_decimal expected;  // expected = 0
  expected.bits[3] = 0b00000000000000000000000000000000;
...
START_TEST(s21_mul_test_56) {
  s21_decimal value1;  // value1 = 45473458277.750
  value1.bits[3] = 0b00000000000000110000000000000000;
  value1.bits[2] = 0b00000000000000000000000000000000;
  value1.bits[1] = 0b00000000000000000010100101011011;
  value1.bits[0] = 0b10011101010100111100110101110110;

  s21_decimal value2;  // value2 = 111815921732.5
  value2.bits[3] = 0b00000000000000010000000000000000;
  value2.bits[2] = 0b00000000000000000000000000000000;
  value2.bits[1] = 0b00000000000000000000000100000100;
  value2.bits[0] = 0b01010111011110111010001010101101;

  s21_decimal expected;  // expected = 5084656651690998246201.8750
...
START_TEST(s21_mul_test_57) {
  s21_decimal value1;  // value1 = 4547345827775.0
  value1.bits[3] = 0b00000000000000010000000000000000;
  value1.bits[2] = 0b00000000000000000000000000000000;
  value1.bits[1] = 0b00000000000000000010100101011011;
  value1.bits[0] = 0b10011101010100111100110101110110;

  s21_decimal value2;  // value2 = 1118159217.325
...
START_TEST(s21_mul_test_58) {
  s21_decimal value1;  // value1 = 454734.58277750
  value1.bits[3] = 0b00000000000010000000000000000000;
  value1.bits[2] = 0b00000000000000000000000000000000;
  value1.bits[1] = 0b00000000000000000010100101011011;
  value1.bits[0] = 0b10011101010100111100110101110110;

  s21_decimal value2;  // value2 = 1.118159217325
  value2.bits[3] = 0b00000000000011000000000000000000;
  value2.bits[2] = 0b00000000000000000000000000000000;
  value2.bits[1] = 0b00000000000000000000000100000100;
  value2.bits[0] = 0b01010111011110111010001010101101;

  s21_decimal expected;  // expected = 508465.66516909982462018750
...
START_TEST(s21_mul_test_59) {
  s21_decimal value1;  // value1 = 45.473458277750
  value1.bits[3] = 0b00000000000011000000000000000000;
  value1.bits[2] = 0b00000000000000000000000000000000;
  value1.bits[1] = 0b00000000000000000010100101011011;
  value1.bits[0] = 0b10011101010100111100110101110110;

  s21_decimal value2;  // value2 = 111815921.7325
  value2.bits[3] = 0b00000000000001000000000000000000;
  value2.bits[2] = 0b00000000000000000000000000000000;
  value2.bits[1] = 0b00000000000000000000000100000100;
  value2.bits[0] = 0b01010111011110111010001010101101;

  s21_decimal expected;  // expected = 5084656651.6909982462018750
...
START_TEST(s21_mul_test_64) {  // positive overflow
  s21_decimal value1;
  value1.bits[3] = 0b00000000000000000000000000000000;
...
START_TEST(s21_mul_test_65) {  // negative overflow
  s21_decimal value1;
  value1.bits[3] = 0b10000000000000000000000000000000;
  value1.bits[2] = 0b01111111111111111111111111111111;
  value1.bits[1] = 0b11111111111111111111111111111111;
...
Suite *test_mul(void) {
  ...
  tcase_add_test(tc, s21_mul_test_0);
  ...
  tcase_add_test(tc, s21_mul_test_14);
  tcase_add_test(tc, s21_mul_test_15);
  tcase_add_test(tc, s21_mul_test_16);
  tcase_add_test(tc, s21_mul_test_17);
  tcase_add_test(tc, s21_mul_test_18);
  tcase_add_test(tc, s21_mul_test_19);
  tcase_add_test(tc, s21_mul_test_20);
  tcase_add_test(tc, s21_mul_test_21);
  tcase_add_test(tc, s21_mul_test_22);
  ...
  tcase_add_test(tc, s21_mul_test_38);
  tcase_add_test(tc, s21_mul_test_39);
  tcase_add_test(tc, s21_mul_test_40);
  tcase_add_test(tc, s21_mul_test_41);
  tcase_add_test(tc, s21_mul_test_42);
  tcase_add_test(tc, s21_mul_test_43);
  tcase_add_test(tc, s21_mul_test_44);*/
  tcase_add_test(tc, s21_mul_test_45);
  tcase_add_test(tc, s21_mul_test_46);
  tcase_add_test(tc, s21_mul_test_47);
  tcase_add_test(tc, s21_mul_test_48);
  tcase_add_test(tc, s21_mul_test_49);
  tcase_add_test(tc, s21_mul_test_50);
  tcase_add_test(tc, s21_mul_test_51);
  tcase_add_test(tc, s21_mul_test_52);
  tcase_add_test(tc, s21_mul_test_53);
  tcase_add_test(tc, s21_mul_test_54);
  tcase_add_test(tc, s21_mul_test_55);
  tcase_add_test(tc, s21_mul_test_56);
  tcase_add_test(tc, s21_mul_test_57);
  tcase_add_test(tc, s21_mul_test_58);
  tcase_add_test(tc, s21_mul_test_59);
  tcase_add_test(tc, s21_mul_test_60);
  tcase_add_test(tc, s21_mul_test_61);
  tcase_add_test(tc, s21_mul_test_62);
  tcase_add_test(tc, s21_mul_test_63);
  tcase_add_test(tc, s21_mul_test_64);
  tcase_add_test(tc, s21_mul_test_65);

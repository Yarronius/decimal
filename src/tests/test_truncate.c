...
START_TEST(truncate_test_1) {
  ...
  int code = truncate(value, &result);
...
START_TEST(truncate_test_10) {
  ...
  decimal value;
  decimal result;
  int code = from_float_to_decimal(num, &value);
...
START_TEST(truncate_test_12) {
  decimal value;     // 79228162514264337593543,950335
  decimal expected;  // 79228162514264337593543
  decimal result;
...
START_TEST(truncate_test_14) {
  decimal value;     //-268.435433
  decimal expected;  //-268
  decimal result;
...
START_TEST(truncate_test_16) {
  float num = 3;
  decimal value;
  from_float_to_decimal(num, &value);

  int code = truncate(value, NULL);
...
Suite *test_truncate(void) {
  ...
  tcase_add_test(tc, truncate_test_5);
  tcase_add_test(tc, truncate_test_6);
  tcase_add_test(tc, truncate_test_7);
  tcase_add_test(tc, truncate_test_8);
  tcase_add_test(tc, truncate_test_9);
  tcase_add_test(tc, truncate_test_10);
  tcase_add_test(tc, truncate_test_11);
  tcase_add_test(tc, truncate_test_12);
  tcase_add_test(tc, truncate_test_13);
  tcase_add_test(tc, truncate_test_14);
  tcase_add_test(tc, truncate_test_15);
  tcase_add_test(tc, truncate_test_16);

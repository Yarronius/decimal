...
START_TEST(is_greater_test_5) {
  ...
  int result = is_greater(dec1, dec2);
...
START_TEST(is_greater_test_6) {
  ...
  from_int_to_decimal(num1, &dec1);
  from_int_to_decimal(num2, &dec2);
  int res1 = is_greater(dec1, dec2);
  int res2 = is_greater(dec2, dec1);
...
Suite *test_is_greater(void) {
  ...
  tcase_add_test(tc, is_greater_test_1);
  tcase_add_test(tc, is_greater_test_2);
  tcase_add_test(tc, is_greater_test_3);
  tcase_add_test(tc, is_greater_test_4);
  tcase_add_test(tc, is_greater_test_5);
  tcase_add_test(tc, is_greater_test_6);
  tcase_add_test(tc, is_greater_test_7);
  tcase_add_test(tc, is_greater_test_8);
  tcase_add_test(tc, is_greater_test_9);
  tcase_add_test(tc, is_greater_test_10);
  tcase_add_test(tc, is_greater_test_11);

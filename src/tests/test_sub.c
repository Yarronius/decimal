...
START_TEST(s21_sub_test_0) {
  ...
  int code = s21_sub(value1, value2, &result);
  s21_from_decimal_to_int(result, &sub);
...
START_TEST(s21_sub_test_7) {
  ...
  int code = s21_from_decimal_to_int(result, &sub);
  s21_from_decimal_to_int(result, &sub);
  ck_assert_int_eq(sub, a - b);
  ck_assert_int_eq(code, 0);
}
...
/*START_TEST(s21_sub_test_25) {
  ...
  int code = s21_sub(value1, value2, &result);
  s21_from_decimal_to_float(result, &sub);
  ck_assert_int_eq(sub, a - b);
  ck_assert_int_eq(code, 0);
}
END_TEST
...
START_TEST(s21_sub_test_52) {  // positive overflow
  s21_decimal value1;
  value1.bits[3] = 0b00000000000000000000000000000000;
...
START_TEST(s21_sub_test_53) {  // negative overflow
  s21_decimal value1;
  value1.bits[3] = 0b10000000000000000000000000000000;
  value1.bits[2] = 0b01111111111111111111111111111111;
  value1.bits[1] = 0b11111111111111111111111111111111;
...
Suite *test_sub(void) {
  ...
  tcase_add_test(tc, s21_sub_test_19);
  tcase_add_test(tc, s21_sub_test_20);
  tcase_add_test(tc, s21_sub_test_21);
  tcase_add_test(tc, s21_sub_test_22);
  tcase_add_test(tc, s21_sub_test_23);
  tcase_add_test(tc, s21_sub_test_24);
  /*tcase_add_test(tc, s21_sub_test_25);
  tcase_add_test(tc, s21_sub_test_26);
  tcase_add_test(tc, s21_sub_test_27);
  tcase_add_test(tc, s21_sub_test_28);
  tcase_add_test(tc, s21_sub_test_29);
  tcase_add_test(tc, s21_sub_test_30);
  tcase_add_test(tc, s21_sub_test_31);
  tcase_add_test(tc, s21_sub_test_32);
  tcase_add_test(tc, s21_sub_test_33);
  tcase_add_test(tc, s21_sub_test_34);
  tcase_add_test(tc, s21_sub_test_35);
  tcase_add_test(tc, s21_sub_test_36);
  tcase_add_test(tc, s21_sub_test_37);
  tcase_add_test(tc, s21_sub_test_38);
  tcase_add_test(tc, s21_sub_test_39);
  tcase_add_test(tc, s21_sub_test_40);
  tcase_add_test(tc, s21_sub_test_41);
  tcase_add_test(tc, s21_sub_test_42);
  tcase_add_test(tc, s21_sub_test_43);
  tcase_add_test(tc, s21_sub_test_44);*/
  tcase_add_test(tc, s21_sub_test_45);
  tcase_add_test(tc, s21_sub_test_46);
  tcase_add_test(tc, s21_sub_test_47);
  tcase_add_test(tc, s21_sub_test_48);
  tcase_add_test(tc, s21_sub_test_49);
  tcase_add_test(tc, s21_sub_test_50);
  tcase_add_test(tc, s21_sub_test_51);
  tcase_add_test(tc, s21_sub_test_52);
  tcase_add_test(tc, s21_sub_test_53);
  tcase_add_test(tc, s21_sub_test_54);

...
START_TEST(s21_from_decimal_to_int_test_1) {
  ...
  int result;
  int code = s21_from_decimal_to_int(value, &result);
...
Suite *test_from_decimal_to_int() {
  ...
  tcase_add_test(tc, s21_from_decimal_to_int_test_7);
  tcase_add_test(tc, s21_from_decimal_to_int_test_8);
  tcase_add_test(tc, s21_from_decimal_to_int_test_9);
  tcase_add_test(tc, s21_from_decimal_to_int_test_10);
  tcase_add_test(tc, s21_from_decimal_to_int_test_11);

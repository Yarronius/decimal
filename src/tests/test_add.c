...
START_TEST(s21_add_test_0) {
  ...
  int code = s21_add(value1, value2, &result);
...
START_TEST(s21_add_test_7) {
  ...
  int code = s21_from_decimal_to_int(result, &sum);
  s21_from_decimal_to_int(result, &sum);
  ck_assert_int_eq(sum, a + b);
  ck_assert_int_eq(code, 0);
}
...
START_TEST(s21_add_test_25) {
  ...
  int code = s21_add(value1, value2, &result);
  s21_from_decimal_to_float(result, &sum);
...
START_TEST(s21_add_test_43) {
  ...
  s21_from_float_to_decimal(b, &value2);
  s21_add(value1, value2, &result);
  int code = s21_from_decimal_to_float(result, &sum);
  s21_from_decimal_to_float(result, &sum);
  ck_assert_int_eq(sum, a + b);
  ck_assert_int_eq(code, 0);
}
...
START_TEST(s21_add_test_45) {
  ...
  s21_decimal expected;  // expected = 79228162514264337593543950334
...
START_TEST(s21_add_test_47) {
  ...
  s21_decimal expected;  // expected = 79228162514264337593543950335
  expected.bits[3] = 0b00000000000000000000000000000000;
  expected.bits[2] = 0b11111111111111111111111111111111;
  expected.bits[1] = 0b11111111111111111111111111111111;
...
START_TEST(s21_add_test_48) {
  s21_decimal value1;  // value1 = 293628689466015337846
  value1.bits[3] = 0b00000000000000000000000000000000;
  ...
  s21_decimal value2;  // value2 = 20098374384509231789
  ...
  s21_decimal expected;  // expected = 313727063850524569635
  expected.bits[3] = 0b00000000000000000000000000000000;
...
START_TEST(s21_add_test_49) {
  ...
  s21_decimal expected;  // expected = 273530315081506106057
  expected.bits[3] = 0b00000000000000000000000000000000;
...
START_TEST(s21_add_test_52) {  // positive overflow
  s21_decimal value1;
  value1.bits[3] = 0b00000000000000000000000000000000;
...
START_TEST(s21_add_test_53) {  // negative overflow
  s21_decimal value1;
  value1.bits[3] = 0b10000000000000000000000000000000;
  value1.bits[2] = 0b01111111111111111111111111111111;
  value1.bits[1] = 0b11111111111111111111111111111111;
...
Suite *test_add(void) {
  ...
  tcase_add_test(tc, s21_add_test_0);
  ...
  tcase_add_test(tc, s21_add_test_18);
  tcase_add_test(tc, s21_add_test_19);
  tcase_add_test(tc, s21_add_test_20);
  tcase_add_test(tc, s21_add_test_21);
  tcase_add_test(tc, s21_add_test_22);
  tcase_add_test(tc, s21_add_test_23);
  tcase_add_test(tc, s21_add_test_24);
  tcase_add_test(tc, s21_add_test_25);
  tcase_add_test(tc, s21_add_test_26);
  tcase_add_test(tc, s21_add_test_27);
  tcase_add_test(tc, s21_add_test_28);
  tcase_add_test(tc, s21_add_test_29);
  tcase_add_test(tc, s21_add_test_30);
  tcase_add_test(tc, s21_add_test_31);
  tcase_add_test(tc, s21_add_test_32);
  tcase_add_test(tc, s21_add_test_33);
  tcase_add_test(tc, s21_add_test_34);
  tcase_add_test(tc, s21_add_test_35);
  tcase_add_test(tc, s21_add_test_36);
  tcase_add_test(tc, s21_add_test_37);
  tcase_add_test(tc, s21_add_test_38);
  tcase_add_test(tc, s21_add_test_39);
  tcase_add_test(tc, s21_add_test_40);
  tcase_add_test(tc, s21_add_test_41);
  tcase_add_test(tc, s21_add_test_42);
  tcase_add_test(tc, s21_add_test_43);
  tcase_add_test(tc, s21_add_test_44);
  tcase_add_test(tc, s21_add_test_45);
  tcase_add_test(tc, s21_add_test_46);
  tcase_add_test(tc, s21_add_test_47);
  tcase_add_test(tc, s21_add_test_48);
  tcase_add_test(tc, s21_add_test_49);
  tcase_add_test(tc, s21_add_test_50);
  tcase_add_test(tc, s21_add_test_51);
  tcase_add_test(tc, s21_add_test_52);
  tcase_add_test(tc, s21_add_test_53);
  tcase_add_test(tc, s21_add_test_54);

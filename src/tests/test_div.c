...
START_TEST(s21_div_test_1) {
  ...
  int code = s21_div(value1, value2, &result);
  s21_from_decimal_to_float(result, &div);
...
START_TEST(s21_div_test_19) {
  ...
  int code = s21_from_decimal_to_float(result, &div);
  s21_from_decimal_to_float(result, &div);
  ck_assert_int_eq(div, a / b);
  ck_assert_int_eq(code, 0);
}
...
START_TEST(s21_div_test_21) {
  ...
  s21_decimal expected;  // expected = 13204693752377389598923991722
...
START_TEST(s21_div_test_24) {
  ...
  s21_decimal expected;  // expected = 40.668142401524248866880841638
...
START_TEST(s21_div_test_26) {
  ...
  s21_decimal expected;  // expected = 40.6681424015242489
  expected.bits[3] = 0b10000000000110110000000000000000;
  expected.bits[2] = 0b10000011011001111110011000100001;
  expected.bits[1] = 0b00100010010101011101101001010000;
  expected.bits[0] = 0b00101000101110010110011110100110;
...
START_TEST(s21_div_test_32) {
  ...
  s21_decimal expected;  // expected = 0.4066814240152424886688084163
...
START_TEST(s21_div_test_33) {
  ...
  s21_decimal expected;  // expected = 4066.8142401524248866880841638
...
START_TEST(s21_div_test_34) {
  ...
  s21_decimal expected;  // expected = 406681.42401524248866880841638
...
START_TEST(s21_div_test_35) {
  ...
  s21_decimal expected;  // expected = 0.000000406681424
  expected.bits[3] = 0b00000000000111000000000000000000;
...
START_TEST(s21_div_test_39) {
  ...
  s21_decimal expected;  // expected = 0.0000004066814240152424886688
  expected.bits[3] = 0b00000000000111000000000000000000;
  expected.bits[2] = 0b00000000000000000000000011011100;
  expected.bits[1] = 0b01110110011000101001010010000011;
  expected.bits[0] = 0b01101001011011010011000110100000;
...
START_TEST(s21_div_test_40) {  // positive overflow
  s21_decimal value1;          // value1 = 79228162514264337593543950335
  value1.bits[3] = 0b00000000000000000000000000000000;
  value1.bits[2] = 0b11111111111111111111111111111111;
  value1.bits[1] = 0b11111111111111111111111111111111;
  ...
  s21_decimal value2;  // value2 = 0.006
...
START_TEST(s21_div_test_41) {  // negative overflow
  s21_decimal value1;
  value1.bits[3] = 0b10000000000000000000000000000000;
  value1.bits[2] = 0b11111111111111111111111111111111;
  value1.bits[1] = 0b11111111111111111111111111111111;
...
Suite *test_div(void) {
  ...
  tcase_add_test(tc, s21_div_test_15);
  tcase_add_test(tc, s21_div_test_16);
  tcase_add_test(tc, s21_div_test_17);
  tcase_add_test(tc, s21_div_test_18);
  tcase_add_test(tc, s21_div_test_19);
  tcase_add_test(tc, s21_div_test_20);
  tcase_add_test(tc, s21_div_test_21);
  tcase_add_test(tc, s21_div_test_22);
  tcase_add_test(tc, s21_div_test_23);
  tcase_add_test(tc, s21_div_test_24);
  tcase_add_test(tc, s21_div_test_25);
  tcase_add_test(tc, s21_div_test_26);
  tcase_add_test(tc, s21_div_test_27);
  tcase_add_test(tc, s21_div_test_28);
  tcase_add_test(tc, s21_div_test_29);
  tcase_add_test(tc, s21_div_test_30);
  tcase_add_test(tc, s21_div_test_31);
  tcase_add_test(tc, s21_div_test_32);
  tcase_add_test(tc, s21_div_test_33);
  tcase_add_test(tc, s21_div_test_34);
  tcase_add_test(tc, s21_div_test_35);
  tcase_add_test(tc, s21_div_test_36);
  tcase_add_test(tc, s21_div_test_37);
  tcase_add_test(tc, s21_div_test_38);
  tcase_add_test(tc, s21_div_test_39);
  tcase_add_test(tc, s21_div_test_40);
  tcase_add_test(tc, s21_div_test_41);
  tcase_add_test(tc, s21_div_test_42);

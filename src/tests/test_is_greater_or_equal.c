...
START_TEST(s21_is_greater_or_equal_test_3) {
  ...
  int res2 = s21_is_greater_or_equal(dec2, dec1);
...
Suite *test_is_greater_or_equal(void) {
  ...
  tcase_add_test(tc, s21_is_greater_or_equal_test_4);
  tcase_add_test(tc, s21_is_greater_or_equal_test_5);
  tcase_add_test(tc, s21_is_greater_or_equal_test_6);
  tcase_add_test(tc, s21_is_greater_or_equal_test_7);
  tcase_add_test(tc, s21_is_greater_or_equal_test_8);
  tcase_add_test(tc, s21_is_greater_or_equal_test_9);
  tcase_add_test(tc, s21_is_greater_or_equal_test_10);
  tcase_add_test(tc, s21_is_greater_or_equal_test_11);
  tcase_add_test(tc, s21_is_greater_or_equal_test_12);
  tcase_add_test(tc, s21_is_greater_or_equal_test_13);
  tcase_add_test(tc, s21_is_greater_or_equal_test_14);
